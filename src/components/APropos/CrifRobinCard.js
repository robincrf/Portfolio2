...
import '../../assets/CrifRobinCard.css';

const CrifRobinCard = () => {
    return (
        <div className="crifo-robin-container">
            <div className="crifo-robin-content">
                <div className="location-badges">
                    <span className="location-badge">Mines Saint Etienne</span>
                    <span className="location-badge">Paris - Aix en Provence</span>
                </div>

                <h1 className="crifo-robin-title">CRIFO<br/>ROBIN</h1>
                ...
                <div className="contact-links">
                    ...
                    >
                        ...
                        <span>robin.crifo@etu.emse.fr</span>
                    </a>

                    <a 
                        href="https://github.com/rskolesac" 
                        target="_blank" 
                    ...
                    >
                        ...
                        <span>github.com/rskolesac</span>
                    </a>
                    ...
                    >
                        ...
                        <span>linkedin.com/in/robin-crifo</span>
                    </a>
                </div>
